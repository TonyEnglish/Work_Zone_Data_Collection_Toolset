...
###
    ...
    eventID     = eventID[len(eventID)-8:len(eventID)]                              #hex string of 4 octates padded with 0 in the front
...
#
#	Setup array for collected data for mapping, constructed node points for approach and WZ lanes, and
#       reference point
### --------------------------------------------------------------------------------------------------
...
#
#       As of Feb. 2018 --  Node point selection based on equidistance is NO LONGER in use...
...
winSize = Label(root, height=20, width=100)
winSize.pack()
